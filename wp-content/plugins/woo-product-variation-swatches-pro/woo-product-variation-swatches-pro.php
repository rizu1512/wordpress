...
if ( !defined('RTWPVSP_VERSION') ) { 
    define('RTWPVSP_VERSION', '2.0.1');
} 

if ( !in_array('woo-product-variation-swatches/woo-product-variation-swatches.php', apply_filters('active_plugins', get_option('active_plugins'))) ) {  
