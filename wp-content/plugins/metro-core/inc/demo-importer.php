...
class Demo_Importer
{
    ...
    public function demo_config($demos)
    {
        $demos_array = array(
            ...
            'demo8' => array(
                'title' => __('Home 8 ( New )', 'metro-core'),
            ...
            'demo9' => array(
                'title' => __('Home 9 ( New )', 'metro-core'),
            ...
            'demo10' => array(
                'title' => __('home 10 jewellery', 'metro-core'),
            ...
            'demo11' => array(
                'title' => __('home 11 winter', 'metro-core'),
            ...
            'demo12' => array(
                'title' => __('home 12 cosmetics ( New )', 'metro-core'),
            ...
            'demo13' => array(
                'title' => __('home 11 auto parts ( New )', 'metro-core'),
        ...
        $download_url = 'http://demo.radiustheme.com/wordpress/demo-content/metro/';
    ...
    public function after_demo_install($collection)
    {
        ...
        $cf7ids = array( 593, 1141, 1208, 1238, 1643 , 2059 );
