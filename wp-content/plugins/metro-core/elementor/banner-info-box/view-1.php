...
if ( $data['hasbtn'] ) {
	$btn = '<div class="rtin-btn-area item-btn-bg"><a class="rtin-btn-bg" '.$attr.'>'.$data['btntext'].'<i class="fa fa-arrow-right"></i></a>
	</div>';
}
...
<div class="rt-el-info-box <?php echo esc_attr( $class );?>">
	...
	<div class="rtin-content-area product-collection-box">
