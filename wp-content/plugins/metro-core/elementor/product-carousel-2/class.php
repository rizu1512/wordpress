...
class Product_Carousel_2 extends Custom_Widget_Base
{

    public function __construct($data = [], $args = null)
    {
        $this->rt_name = __('Product Carousel 2', 'metro-core');
        $this->rt_base = 'rt-product-carousel-2';
