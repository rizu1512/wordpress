...
class Custom_Widget_Init {
	...
	public function init() {
		...
		$widgets1 = array(			
			...
			'banner-info-box'   => 'Banner_Info_Box',
			'accordion'         => 'Accordion',
			'button'            => 'Button',
			...
			'modern-banner-slider'        => 'Modern_Banner_Slider',
		);
		...
		if ( class_exists( 'WooCommerce' ) ) {
			...
			$widgets2 = array(
				...
				'product-categories-slider'     => 'rt_product_categories_slider',
				...
				'product-advanced-grid' 		=> 'Product_Advanced_Grid',
				'split-slider'            		=> 'Split_Slider',
				'bannerbox'            		    => 'Banner_Box',
				'product-slider-4'              => 'Product_Slider_4',
				'feature-box-3'                 => 'Feature_Box_3',
				'product-carousel-2'            => 'Product_Carousel_2',
				'countdown'           			=> 'RT_Countdown',
				'category-carousel'             => 'RT_Category_Carousel',
				'logo-grid'                     => 'RT_Logo_Grid',
				'product-carousel-list'         => 'Product_Carousel_List',
				'adbox'         				=> 'RT_AdBox',
			);
		}
