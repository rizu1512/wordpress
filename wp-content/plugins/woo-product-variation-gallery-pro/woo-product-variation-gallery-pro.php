...
if ( !defined('RTWPVGP_VERSION') ) { 
    define('RTWPVGP_VERSION', '2.0.1');
} 

if ( !in_array('woo-product-variation-gallery/woo-product-variation-gallery.php', apply_filters('active_plugins', get_option('active_plugins'))) ) {  
