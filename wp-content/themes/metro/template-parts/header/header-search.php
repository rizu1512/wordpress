...
<div class="product-search">
	<form method="get" action="<?php echo esc_url(get_bloginfo('url'));?>">
		<div class="input-group">
			<input type="text" autocomplete="off" name="s" class="product-search-input product-autocomplete-js form-control" placeholder="<?php esc_attr_e( 'Search Products Here', 'metro' );?>" value="<?php echo esc_attr( $search );?>">
			<input type="hidden" name="post_type" value="product">
			<i class="product-autoaomplete-spinner fa fa-spinner fa-spin"></i>
