    ...
    array(
        ...
        'fields'  => array(
            ...
            array(
                'id'       => 'logo_type',
                'type'     => 'switch',
                'title'    => esc_html__( 'Logo type', 'metro' ),
                'on'       => esc_html__( 'Text', 'metro' ),
                'off'      => esc_html__( 'Image', 'metro' ),
            ),
            ...
            array(
                'id'       => 'logo_text',
                'type'     => 'text',
                'title'    => esc_html__( 'Logo label', 'metro' ),
                'default'  => esc_html__( 'Metro', 'metro' ),
                'required' => array( 'logo_type', '=', true ) 
            ),
            ...
            array(
                'id'       => 'mobile_logo_typo',
                'type'     => 'typography',
                'title'    => esc_html__( 'Mobile Logo typography', 'metro' ),
                'text-align'  => false,
